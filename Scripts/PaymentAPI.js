var PaymentAPI = function (APIUrl) {
    ...
    this.GetCompanyPaymentBankCard = function (CT, GUID, CurrencyType, PaymentMethod, cb) {
    ...
    this.CheckBankCardDepostit = function (CT, GUID,cb) {
    ...
    this.CompleteReceiptFile = function (CT, GUID, UploadId, cb) {
    ...
    this.CreateReceiptFIleUpload = function (CT, GUID, PaymentSerial, ExtName, cb) {
    ...
    this.GetUserAccountBankCard = function (CT, GUID, CurrencyType, PaymentMethod, cb) {
    ...
    this.BankCardDepostitCancel = function (CT, GUID, PaymentSerial, cb) {
    ...
    this.UploadReceiptFIle = function (CT, GUID, UploadId, ChunkIndex, ContentB64 ,cb) {
    ...
    this.BankCardDepostit = function (CT, GUID, CurrencyType, PaymentMethod, Amount, Description, cb) {
    ...
    this.BankCardWithdrawal = function (CT, GUID, CurrencyType, PaymentMethod, Amount, WalletPassword, BankCardGUID, cb) {
