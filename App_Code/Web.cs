...
public static class Web
{
    ...
    public static string GWebApiUrl = System.Configuration.ConfigurationManager.AppSettings["GWebAPI.Web.WebAPI"];
    public static string GWebURL = System.Configuration.ConfigurationManager.AppSettings["GWebURL"];
    public static string GPlatformURL = GWebURL + "/API/GamePlatform";
    ...
    public static byte[] GenerateQRCode_URL(string URL, int PointPixel)
    {
